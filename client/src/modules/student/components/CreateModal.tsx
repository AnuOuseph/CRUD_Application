...
const CreateModal: React.FC<MyModalProps> = ({ isOpen, onRequestClose, contentLabel }) => {
  return (
    <Modal
      isOpen={isOpen}
    ...
    >
      <div className="p-5 bg-white rounded-xl">
        ...
        <div className='w-[100%] flex flex-col items-center'>
            <button className='w-[80%] text-white my-1 py-1 rounded' style={{backgroundColor:'#22c55e'}} onClick={onRequestClose}>Submit</button>
